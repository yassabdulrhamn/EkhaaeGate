<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li><a href="/dashboard"><i class="fa fa-book"></i> <span>الرئيسية</span></a></li>
      <li><a href="/lists/branches"><i class="fa fa-book"></i> <span>الفروع</span></a></li>
      <li><a href="/orphans/list"><i class="fa fa-book"></i> <span>الأبناء</span></a></li>
      <li><a href="/lists/homes"><i class="fa fa-book"></i> <span>المنازل</span></a></li>
      <li><a href="/lists/homes"><i class="fa fa-book"></i> <span>الموظفون</span></a></li>
      <!--
