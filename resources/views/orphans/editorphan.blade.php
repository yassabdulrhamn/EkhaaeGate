    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Update Orphan</div>

                <div class="panel-body">
                  {!! Form::open([ 'action' => ['OrphnsController@update',$orphan->orpNationalID],'class'=>'form-horizontal','method' => 'POST' ]) !!}
                  {{Form::hidden('_method','PUT')}}
                        <div class="form-group{{ $errors->has('NationalID') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="NationalID" type="number" class="form-control" name="NationalID" value="{{$orphan->orpNationalID}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('MinistryNo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="MinistryNo" type="number" class="form-control" name="MinistryNo" value="{{$orphan->orpMinistryNo}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('EkhaaNo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="EkhaaNo" type="number" class="form-control" name="EkhaaNo" value="{{ $orphan->orpEkhaaNo }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('Firstname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Firstname" type="text" class="form-control" name="Firstname" value="{{ $orphan->orpFirstname }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('SecName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="SecName" type="text" class="form-control" name="SecName" value="{{ $orphan->orpSecName }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('ThirdName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ThirdName" type="text" class="form-control" name="ThirdName" value="{{ $orphan->orpThirdName }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('orpForthName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ForthName" type="text" class="form-control" name="ForthName" value="{{ $orphan->orpForthName }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="number" class="form-control" name="mobile" value="{{ $orphan->orpMobile }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{$orphan->orpEmail}}" required>
